...
back_img = preparar_imagen('photos/Python-logo-notext.png')
front_img = preparar_imagen('photos/celeste.jpg')
...
for i in range(num): 
    ...
    for j in range(num): 
        ...
        b.grid(row=i, column=j, sticky='nswe', padx=20, pady=20, ipadx=10, ipady=10)
        buttons.append(b)
        count += 1
